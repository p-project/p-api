...
class FeatureContext extends RestContext implements Context, SnippetAcceptingContext
{
    ...
    public function __construct(Request $request, ManagerRegistry $doctrine, Kernel $kernel)
    {
        ...
        $this->helpers['Profile'] = new ProfileHelper($this->manager, $this->helpers['Account']);
        $this->helpers['Channel'] = new ChannelHelper($this->manager, $this->helpers['Profile']);
        $this->helpers['Playlist'] = new PlaylistHelper($this->manager, $this->helpers['Profile']);
        ...
        $this->helpers['View'] = new ViewHelper($this->manager, $this->helpers['Profile'], $this->helpers['Video']);
        $this->helpers['Forum'] = new ForumHelper($this->manager, $this->helpers['Profile'], $this->helpers['Video']);
        $this->helpers['Review'] = new ReviewHelper($this->manager, $this->helpers['Profile'], $this->helpers['Video']);
        $this->helpers['Reply'] = new ReplyHelper($this->manager, $this->helpers['Profile'], $this->helpers['Review']);
        $this->helpers['Seeder'] = new SeederHelper($this->manager, $this->helpers['Profile'], $this->helpers['Video']);
        ...
        $this->helpers['Comment'] = new CommentHelper($this->manager, $this->helpers['Profile'], $this->helpers['Video']);
    }
